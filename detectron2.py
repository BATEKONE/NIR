...
def setup_cfg():
    ...
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 2  # helmet и no_helmet
    cfg.MODEL.WEIGHTS = "output/model_final.pth"  # путь к обученной модели
...
metadata = MetadataCatalog.get("helmet_train")
metadata.thing_classes = ["helmet", "no_helmet"]
